...
namespace InstaMenu.Infrastructure.Migrations
{
    ...
    [Migration("20260115211919_menuItemSizes")]
    partial class menuItemSizes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstaMenu.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.Property<bool>("HasMultipleSizes")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("InstaMenu.Domain.Entities.MenuItemSize", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InstaMenu.Domain.Entities.MenuItemSize", b =>
                {
                    b.HasOne("InstaMenu.Domain.Entities.MenuItem", "MenuItem")
                        .WithMany("Sizes")
